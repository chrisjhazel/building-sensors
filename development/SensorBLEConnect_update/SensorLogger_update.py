...
def main():
    ...
    try:
        ...
        #No arguments passed, check out saved file
...
def get_args():
    ...
    with open('sensor_directory.csv', 'a', newline = '') as file:
        csv_write = csv.writer(file, delimiter=',')
        csv_write.writerow(args)

    return args

def read_sensors():
    with open('sensor_directory.csv', 'r', newline='') as file:
